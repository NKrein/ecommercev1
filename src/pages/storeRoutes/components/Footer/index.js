      ...
      <Container fluid>
        <Row className='footer'>
          ...
          <Col xs={12} sm={12} md={12}>
            <p className='copyright'>Todos los derechos reservados | Copyright © 2021 Dharma Diseños | <a href='https://nkrein.dev' className='currentLink' target="_blank">Desarrollo por NKrein</a></p>
          </Col>
        </Row>
      </Container>
    </footer>
